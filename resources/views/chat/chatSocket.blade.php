...
<script type="text/javascript" src="{{ URL::asset('assets/js/SocketChat.js') }}"></script>
<script type="text/javascript">
;(function(){
    // create unique SocketChat object
    var socketChat = new SocketChat(JSON.parse('{!! json_encode($user) !!}'),{{ $chat->id }});

    $(window).load(function(){
        socketChat.bindEvent();
    })
})()
</script>
@endsection
